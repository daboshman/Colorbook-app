...
export function AuthButton() {
  ...
  return (
    <button
      onClick={() => signIn()}
      className="flex items-center gap-2 rounded-full bg-white border border-gray-300 px-4 py-1.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 transition-colors"
    >
